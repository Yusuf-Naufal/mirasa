                ...
                <div class="flex gap-3 cursor-pointer flex-1 min-w-0"
                    ...
                    <div class="flex flex-col justify-center overflow-hidden">
                        ...
                        <div class="mt-1 flex flex-wrap gap-1">
                            ...
                            @else
                                <span
                                    class="px-2 py-0.5 rounded-full text-[10px] font-bold bg-gray-100 text-gray-400 uppercase tracking-wider">
                                    No Role
                                </span>
                            @endif
                        </div>
            ...
            <div x-show="openCardId === {{ $i->id }}" x-collapse x-cloak
                ...
                <div class="grid grid-cols-1 gap-2">
                    ...
                    <div class="flex justify-between items-center gap-1">
                        ...
                        <span
                            class="text-xs text-gray-700 font-medium truncate">{{ $i->perusahaan->nama_perusahaan ?? 'All Akses' }}</span>
                    </div>
                    <div class="flex justify-between items-center gap-1">
                        <span class="text-[10px] font-bold text-gray-400 uppercase tracking-tight">Kota:</span>
                        <span
                            class="text-xs text-gray-700 font-medium truncate">{{ $i->perusahaan->kota ?? 'All Akses' }}</span>
                    </div>
                    <div class="flex justify-between items-center gap-1">
    ...
    @empty
        <div class="text-center py-10 bg-gray-50 rounded-xl border-2 border-dashed border-gray-200">
            ...
            <a href="{{ route('user.create') }}"
                class="mt-3 inline-block text-green-600 text-xs font-bold hover:underline uppercase">Tambah User
                Baru</a>
        </div>
    @endforelse
</div>
