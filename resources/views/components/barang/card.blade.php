            ...
            <div class="flex justify-between items-start gap-3">
                ...
                <div class="flex gap-3 cursor-pointer flex-1 min-w-0"
                    ...
                    <div class="flex-shrink-0">
                        {{-- TAMPILKAN FOTO BARANG (Ganti dari Angka Index) --}}
                        <div
                            class="h-14 w-14 rounded-lg overflow-hidden border border-gray-100 shadow-sm bg-gray-50 flex items-center justify-center">
                            @if ($i->foto)
                    ...
                    <div class="flex flex-col justify-center overflow-hidden">
                        <div class="flex items-center gap-2">
                            <h2 class="text-sm font-bold text-gray-900 truncate">{{ $i->nama_barang }}</h2>
                                    ...
                                    @can('barang.activate')
                                        <li>
                                            <form id="aktif-form-{{ $i->id }}"
                                                action="{{ route('barang.activate', $i->id) }}" method="POST">
                                                @csrf
                                                @method('PATCH')
            ...
            <div x-show="openCardId === {{ $i->id }}" x-collapse x-cloak
                ...
                <div class="grid grid-cols-1 gap-2">
                    ...
                    <div class="flex justify-between gap-1">
                        ...
                        <span class="text-xs text-gray-700 font-medium">{{ $i->jenisBarang->nama_jenis ?? '-' }}</span>
                    </div>
                </div>
            </div>
