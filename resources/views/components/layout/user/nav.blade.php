    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                <button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" type="button" class="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none">
                ...
                <a href="/" class="flex ms-2 md:me-24 items-center group">
                    <div class="hidden md:block me-3 group-hover:scale-110 transition-transform duration-300">
                        <img src="{{ asset('assets/logo/logo_pt_mirasa_food-removebg-preview.png') }}" alt="Logo" class="w-10 h-10 object-contain">
                    </div>
                    <span class="self-center text-base font-extrabold sm:text-lg whitespace-nowrap bg-clip-text text-transparent bg-gradient-to-r from-red-700 to-red-600">
                ...
                <div class="relative ms-3">
                    <button type="button" 
                        ...
                        <div class="hidden md:block text-left pr-2">
                            <p class="text-sm font-semibold text-gray-800 leading-none">{{ auth()->user()->name ?? 'No Name' }}</p>
                    ...
                    <div class="absolute right-0 z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-xl shadow-lg border border-gray-100 min-w-[170px]" 
                        ...
                        <div class="px-4 py-3 md:hidden">
                            ...
                            <span class="block text-xs text-gray-500 truncate uppercase">{{ auth()->user()->roles->first()->name ?? 'No Role' }}</span>
                        </div>
                        <ul class="py-2">
                            {{-- <li>
