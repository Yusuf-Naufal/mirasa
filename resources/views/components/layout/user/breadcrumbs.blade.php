<nav class="flex mb-6" aria-label="Breadcrumb">
    <ol class="inline-flex items-center text-sm font-medium">
        ...
        <li class="inline-flex items-center">
            <a href="/dashboard" class="text-gray-400 hover:text-[#FFC829] transition-colors">
        ...
        @foreach (request()->segments() as $segment)
            @php
                ...
                if ($segment == 'edit') $displayValue = 'edit data';
                if ($segment == 'create') $displayValue = 'tambah baru';
            @endphp
