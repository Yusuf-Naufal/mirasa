<x-layout.beranda.app title="Tambah Produksi">
    <div class="min-h-screen bg-gray-50/50 md:px-10 py-8">
        <div class="mx-auto flex flex-col pt-12">
            ...
            <div class="bg-white rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden">
                <form id="inventoryForm" action="{{ route('inventory.store-produksi') }}" method="POST"
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
                        ...
                        <div class="lg:col-span-7 space-y-8">
                            ...
                            <button type="submit"
                                ...
                                <span class="btn-text">Catat Produksi Masuk</span>
