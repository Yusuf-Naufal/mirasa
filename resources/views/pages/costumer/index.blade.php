        ...
        <div class="flex min-h-screen items-center justify-center p-4">
            ...
            <div
                ...
                <div class="border-b border-gray-100 px-8 py-5 flex items-center justify-between">
                    <div>
                        <h3 class="text-xl font-bold text-gray-900">Import Data Costumer</h3>
                        <p class="text-sm text-gray-500">Unggah data pelanggan secara massal.</p>
                    </div>
                ...
                <div class="p-8">
                        ...
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                ...
                                <ul class="mt-1 text-xs text-amber-700 space-y-1 list-disc ml-4">
                                    <li><strong>Nama Costumer</strong> tidak boleh sama dengan data yang sudah ada.</li>
                                    <li><strong>Kode Costumer</strong> harus unik (tidak boleh duplikat).</li>
                    ...
                    <form action="{{ route('costumer.import') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="flex items-center gap-4">
                            <a href="{{ route('costumer.download-template') }}"
