<x-layout.user.app title="Daftar Berita">
        ...
        <div class="flex flex-col gap-4 md:justify-between">
            <div class="flex w-full flex-col gap-3 md:w-auto md:flex-row md:items-center md:justify-between">
                <div class="flex gap-2">
                    <a type="button" href="{{ route('berita.create') }}"
                        ...
                        <span class="hidden md:block md:ml-2">Tambah Berita</span>
                    </a>
                    ...
                    <button onclick="openModal('filterModal')"
                        ...
                        <span class="hidden md:block md:ml-2">Filter Berita</span>
                    </button>

                </div>

                <form action="{{ route('berita.index') }}" method="GET" class="relative w-full md:w-64">
    ...
    <div id="filterModal" class="fixed inset-0 z-50 hidden items-center justify-center p-4">
        ...
        <div class="relative w-full max-w-md rounded-2xl bg-white shadow-2xl">
            ...
            <form action="{{ route('berita.index') }}" method="GET" class="p-6">
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <select name="status"
                            ...
                            <option value="aktif" {{ request('status') == 'aktif' ? 'selected' : '' }}>Public (Tampil)
                            </option>
                            <option value="tidak_aktif" {{ request('status') == 'tidak_aktif' ? 'selected' : '' }}>Private
                                (Sembunyi)</option>
                        </select>
                    </div>
