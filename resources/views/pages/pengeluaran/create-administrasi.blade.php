<x-layout.beranda.app title="Tambah Pengeluaran Administrasi">
                    ...
                    <div class="lg:col-span-2 space-y-6 text-left">
                        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                {{-- Hidden Kategori --}}
                                <input type="hidden" name="kategori" value="ADMINISTRASI">
                                ...
                                <div class="text-left">
                                    ...
                                    <input type="text" name="sub_kategori" id="sub_kategori"
                                        placeholder="Contoh: SERTIFIKAT, ADMINISTRASI"
