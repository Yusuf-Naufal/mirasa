    ...
    <div class="md:px-10 py-6 flex flex-col" x-data="{ menuOpen: false }">
        <div class="flex-1 pt-12">
            ...
            <div class="mb-4 text-left">
                ...
                <p class="text-sm text-gray-500 font-medium italic">*Gunakan kategori ini untuk maintenance
                    barang-barang kantor.</p>
            </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 px-4 md:px-0">
                    ...
                    <div class="space-y-6 text-left">
                        ...
                        <div class="flex flex-col gap-3 pt-4">
                            <button type="submit"
                                class="btn-submit w-full bg-amber-700 hover:bg-amber-800 text-white font-bold py-4 rounded-xl shadow-lg transition-all flex justify-center items-center gap-2">
