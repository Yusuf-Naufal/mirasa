<x-layout.beranda.app title="Tambah Pengeluaran Limbah">
        ...
        <div class="flex-1 pt-12">
            ...
            <div class="mb-4 text-left">
                ...
                <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight mt-2">Pengeluaran <span
                        class="text-green-600">Limbah</span></h1>
                <p class="text-sm text-gray-500 font-medium italic">*Gunakan kategori ini mengelola pengeluaran limbah perusahaan</p>
            </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 px-4 md:px-0">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="text-left">
                                    ...
                                    <input type="text" name="sub_kategori" id="sub_kategori"
                                        placeholder="Contoh: LIMBAH PADAT, KIMIA"
                    ...
                    <div class="space-y-6 text-left">
                        ...
                        <div class="flex flex-col gap-3 pt-4">
                            <button type="submit"
                                class="btn-submit w-full bg-slate-700 hover:bg-slate-800 text-white font-bold py-4 rounded-xl shadow-lg transition-all flex justify-center items-center gap-2">
