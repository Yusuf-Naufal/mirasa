    ...
    <div class="md:px-10 py-6 flex flex-col" x-data="{ tab: 'PRODUKSI', menuOpen: false }">
        <div class="flex-1 pt-12">
            ...
            <div class="mb-8 flex flex-col md:flex-row gap-4 justify-between items-center">
                ...
                {{-- Dropdown Button --}}
                @canany(['barang-keluar.create-produksi', 'barang-keluar.create-bahan-baku',
                    ...
                    <div class="relative w-full md:w-56">
                        ...
                        <div x-show="menuOpen" x-transition
                            ...
                            @can('barang-keluar.create-produksi')
                                <a href="{{ route('barang-keluar.create-produksi') }}"
                                    ...
                                    <div class="flex flex-col"><span class="text-sm font-bold">Operasional</span>
                                        <span class="text-[10px] text-gray-400">Bahan Penolong</span>
                                    </div>
                                </a>
                            @endcan
                            @can('barang-keluar.create-penjualan')
                                <a href="{{ route('barang-keluar.create-penjualan') }}"
                                    ...
                                    <div class="flex flex-col"><span class="text-sm font-bold">Distribusi</span>
                                        <span class="text-[10px] text-gray-400">Produk Jadi
                                            (FG/WIP/EC)
                                        </span>
                                    </div>
                                </a>
                            @endcan
                            @can('barang-keluar.create-bahan-baku')
            ...
            <div class="flex gap-4 border-b border-gray-100 mb-6">
                ...
                @can('barang-keluar.penjualan')
                    <a href="{{ route('barang-keluar.index', ['tab' => 'PENJUALAN']) }}"
                        class="pb-4 px-2 border-b-2 font-bold text-sm transition-all {{ $activeTab === 'PENJUALAN' ? 'border-blue-600 text-blue-600' : 'border-transparent text-gray-400 hover:text-gray-600' }}">
                        Distribusi
                    </a>
                @endcan

                @can('barang-keluar.bahan-baku')
