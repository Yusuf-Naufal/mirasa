                ...
                <form action="{{ route('barang-masuk.update', $item->id) }}" method="POST" class="p-6 md:p-10">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
                        ...
                        <div class="lg:col-span-7 space-y-8 relative z-10">
                            ...
                            <button type="submit"
                                class="w-full bg-yellow-600 hover:bg-yellow-700 text-white py-4 rounded-2xl font-black uppercase tracking-widest shadow-lg shadow-yellow-200 transition-all hover:scale-[1.01] active:scale-95 flex items-center justify-center gap-3">
